process run_hcl {
    ...
    tag "HCL process"
    publishDir "${params.output_dir}/HierarchicalCluster.observation_clusters", mode:"copy", pattern:"obs.tsv"
    publishDir "${params.output_dir}/HierarchicalCluster.feature_clusters", mode:"copy", pattern:"feat.tsv"
